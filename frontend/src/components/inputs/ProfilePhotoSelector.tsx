    ...
    <div className="flex justify-center mb-6">
      ...
      {!profilePic ? (
        <div className="w-20 h-20 flex justify-center items-center bg-purple-100 rounded-full relative">
          ...
          <button type="button" onClick={onChooseFile} className="w-8 h-8 flex items-center justify-center bg-primary cursor-pointer rounded-full text-white absolute -bottom-1 -right-1">
            <LuUpload />
          </button>
        </div>
      ) : (
